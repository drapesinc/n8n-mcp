...
export declare function extractBracketExpressions(value: string): string[];
export declare function hasDanglingOpenBracket(value: string): boolean;
export declare function hasBracketExpression(value: unknown): boolean;
